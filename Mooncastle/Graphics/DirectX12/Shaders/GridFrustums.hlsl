...
void ComputeGridFrustumsCS(uint3 DispatchThreadID : SV_DispatchThreadID)
{
	...
	//Converts the screen-space points to view space.
	...
	//Builds the frustum planes from the view space points.
	...
	//Stores the computed frustum in global memory for thread IDs that are within the bounds of the grid.
