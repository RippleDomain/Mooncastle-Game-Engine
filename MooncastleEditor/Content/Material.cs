...
namespace MooncastleEditor.Content
{
    ...
    class AppliedMaterial : Asset
    {
        ...
        public bool UploadToEngine()
        {
            ...
            //In the case that the material hasn't been modified since the last upload, there's no need to re-upload.
            //SequenceEqual() is slow, however, our data is small and this calculation is not done frequently, so it is acceptable.
            ...
            //The case that the material was modified and is unique or material is new and unique.
            else
            {
            ...
            //Unload the old variant if there is any.
